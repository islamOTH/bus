...
import com.svu.bus.databinding.FragmentAddControllerBinding;
import com.svu.bus.databinding.FragmentAddDriverBinding;
...
public class AddNewControllerFragment extends Fragment
{


    private FragmentAddControllerBinding binding;
    private Fragments fragments;
    @Inject
    public UserViewModel userViewModel;

    @Inject
    public AddNewControllerFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {     binding = DataBindingUtil.inflate(inflater, R.layout.fragment_add_controller, container, false);
    ...
    public void register()
    {
        ...
        userViewModel.userliveData.observe(getActivity(),user -> {
            if (user==null){
                ...
                new Handler().postDelayed(() -> { toAllControllerFragment();},1000);
            }
        });
    ...
    public void toAllControllerFragment()
    {  try{getActivity()
                .getSupportFragmentManager()
                .beginTransaction()
                .setCustomAnimations(R.anim.slide_in_left, R.anim.slide_out_left)
                .replace(R.id.mainFrame,fragments.getAllMyControllerFragment())
                .commit();}
