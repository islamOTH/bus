...
public class AllMyUsersFragment extends Fragment
{
    private FragmentAllMyUserBinding binding;
    private UserViewModel userViewModel;
    private Fragments fragments;
    private UserAdapter userAdapter;
    @Inject
    public AllMyUsersFragment(UserViewModel userViewModel, UserAdapter userAdapter) {
    ...
    {   binding = DataBindingUtil.inflate(inflater, R.layout.fragment_all_my_user, container, false);
        binding.rec.setLayoutManager(new LinearLayoutManager(getActivity()));
        binding.setAdapter(userAdapter);
        userViewModel=new ViewModelProvider(getActivity()).get(UserViewModel.class);
        userViewModel.listUserLiveData.observe(getActivity(),
    ...
    public void toAddNewMyUserFragment()
    {
        getActivity()
                .getSupportFragmentManager()
                .beginTransaction()
                .setCustomAnimations(R.anim.slide_in_left, R.anim.slide_out_left)
                .replace(R.id.mainFrame,fragments.getAddNewMyUserFragment())
                .commit();
    }
